...
(function (factory) {
	...
	$.validator.addMethod(
		...
		function (value, element, param) {
			var maxSizeInBytes = parseInt(param);
		...
		function (param, element) {
			var maxSizeInMegabytes = parseInt(param) / (1024 * 1024); // Convert to megabytes
			return (
				"Ukuran file tidak bisa melebihi " +
				maxSizeInMegabytes.toFixed(0) +
				" MB."
			);
		}
	);
